# nvim-treesitter-queries-promql

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-promql/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-promql/actions/workflows/validate.yml)

Neovim tree-sitter queries for **promql**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-promql",
...
- [ ] Changes are scoped to `promql` — do not include files for other languages
